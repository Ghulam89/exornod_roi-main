...
const Header = () => {
  ...
  return (
    <nav
      className={`tw-top-0 tw-relative tw-w-full tw-z-20 tw-bg-[#1B0938] navbar-border-bottom ${
        scrollBackground ? "" : ""
      } `}
    >
      <div className="tw-flex tw-items-center tw-font-medium tw-h-20 container tw-mx-auto tw-justify-between">
        <div className="">
          <img
            src={logo}
        ...
        <div className=" tw-flex tw-gap-16  tw-items-center ">
          <ul className="lg:tw-flex tw-hidden tw-items-center tw-pt-2 tw-gap-8 tw-font-[Poppins]">
            ...
            <li>
              <Link
                ...
                className="tw-text-white tw-text-md"
              >
                Ecosystem
              </Link>
            </li>
            ...
            <li>
              <Link to={"#"} className="tw-text-white tw-text-md tw-flex tw-items-center tw-gap-1">
                 Product <FaAngleDown size={15} />
              </Link>
            </li>
          ...
          <div className="md:tw-block tw-hidden">
            <Button
              ...
              className={" tw-rounded-lg tw-text-black tw-text-md tw-font-normal"}
        ...
        <div
          className={`
            lg:tw-hidden tw-z-40       tw-bg-[#101010]  tw-shadow-xl  tw-fixed tw-w-full tw-top-0 tw-overflow-y-auto tw-bottom-0 tw-leading-10 tw-py-10 
        ...
        >
          ...
          <ul className="tw-p-0 tw-relative tw-px-9 tw-pt-3 ">
            ...
            <li className=" tw-pt-5">
              ...
              onClick={() => open()} 
              className={' tw-rounded-lg tw-text-black '}
