...
const About = () => {
  ...
  return (
    <div  id='aboutSection'  className='  tw-relative   tw-w-full tw-h-auto'>
      ...
      <div className='container'>
        <div className='row  sm:tw-text-start  tw-text-center g-5 tw-items-center'>
            ...
            <h1 className=" tw-text-white  tw-font-Dots    tw-font-extralight   md:tw-text-[40px] tw-text-[28px]">
            
            How to <span className=' tw-text-primary tw-font-Dots'>Stake?</span>
          
            </h1>

           <ul className='  p-0 flex tw-flex-col tw-gap-3 tw-mt-5'>
            <li>
               <h2 className="   tw-text-primary   tw-font-Dots   md:tw-text-[30px] tw-text-[20px]">
            
           Add USDT Tokens
          
            </h2>
            <p className=" tw-text-white  tw-font-Intal sm:tw-text-start tw-text-center  tw-leading-8">
    ...
    Stake Wallet
            ...
            <p className=" tw-text-white  sm:tw-text-start tw-text-center tw-font-Intal   tw-leading-8">
           ...
           <Button
                rIcons={<FaLongArrowAltRight className=' tw-ml-1 tw-text-primary' />}
                label={"More Details"}
                className={'  tw-bg-transparent tw-rounded-md tw-text-primary  tw-border   tw-border-primary tw-font-medium tw-py-3'}
              />
            ...
            <div className='col-lg-5 col-md-12'>
              <div className='row'>
                <div className="col-md-12 tw-mx-auto">
                   ...
                   <div className='  tw-absolute tw-right-4 -tw-z-10  tw-top-0'>
                    <img  src={require('../../assets/images/boost_circle.png')} className=' tw-mx-auto tw-w-full' alt='' />
                   </div>
                   </div>
                </div>
              </div>
