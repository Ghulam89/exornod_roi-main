...
const InvestmentHistory = (props) => {
  ...
  return (
    <div className="container tw-mx-auto  tw-mt-8 tw-text-white">
         ...
         Investment <span className="hero-title-gradient tw-font-Dots tw-inline-block">History</span>
      </h2>
      ...
      <div className="investment-table-wrap tw-overflow-hidden">
        <div className="tw-max-h-96 tw-overflow-y-auto">
          <table className="tw-w-full tw-text-sm tw-text-white">
            <thead className="tw-sticky tw-top-0 tw-z-10 investment-table-header ">
              <tr>
                <th className="tw-p-3 tw-text-left tw-whitespace-nowrap tw-text-white tw-text-center">No</th>
                <th className="tw-p-3 tw-text-left tw-whitespace-nowrap tw-text-white tw-text-center">Amount</th>
                <th className="tw-p-3 tw-text-left tw-whitespace-nowrap tw-text-white tw-text-center">Date</th>
                <th className="tw-p-3 tw-text-left tw-whitespace-nowrap tw-text-white tw-text-center">Exp. Return</th>
                <th className="tw-p-3 tw-text-left tw-whitespace-nowrap tw-text-white tw-text-center">
                  Double ROI{" "}
                  <FaInfoCircle
                    data-tooltip-id="tooltip-2direct"
                    className="tw-inline tw-ml-1 tw-text-white"
                  />
                </th>
                <th className="tw-p-2.5 tw-text-left tw-whitespace-nowrap tw-text-white">
                  Principal Return{" "}
                  <FaInfoCircle
            ...
            <tbody className="investment-table-body">
              {props.Allinvestment.map((inv, i) => (
                <tr
                  key={i}
                  className="tw-border-b tw-border-white/10 tw-text-white"
                >
